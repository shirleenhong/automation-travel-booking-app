...
class ExtendedCustomSyExLibrary:
    ...
    def select_team_name(self, team_name):
        ...
        team_selection_window = app[u'WindowsForms10.Window.8.app.0.bce5ad_r17_ad1']
        team_selection_window.Wait('ready', 60, 3)
        team_selection_window.SetFocus()
        checkbox_list_control = app[u'WindowsForms10.LISTBOX.app.0.16c5d04_r17_ad1']
        checkbox_list_control.Wait('ready', 60, 3)
        checkbox_list_control.SetFocus()        
        try:
            team_list = team_selection_window.ListBox
            team_list.Wait('ready', 60, 3)
            team_list.SetFocus()
