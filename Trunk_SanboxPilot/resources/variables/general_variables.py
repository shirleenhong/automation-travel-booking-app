...
date_ib_9 = '18DEC'
date_ob_10 = '22DEC'
churning_airlines_sabre = '¥*DLBASQCXAB'
churning_airlines_galileo = '/DL-/BA-/SQ-/CX-/AB-'
churning_airlines_amadeus = '/A-BA,DL,CX,SQ,AB'
churning_airlines_apollo = '-BA.DL.SQ.AB'
