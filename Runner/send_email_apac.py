...
def send_mail():
    ...
    recipients = [  'KarloAnthony.Beltran@carlsonwagonlit.com',
                    'JohnDriel.Bogar@carlsonwagonlit.com',
                    'JonaMyrrh.Cabela@carlsonwagonlit.com',
                    'TChua@carlsonwagonlit.com',
                    'Harold.Cuellar@carlsonwagonlit.com',
                    'Yathish.Kempashanaiah@carlsonwagonlit.com',
                    'HarshaVardhan.Konduru@carlsonwagonlit.com',
                    'AObsum@Carlsonwagonlit.com',
                    'Jayson.Panganiban@carlsonwagonlit.com',
                    'Waseem.Pasha@carlsonwagonlit.com',
                    'Roaxanne.Rabanes@carlsonwagonlit.com',
                    'Purushothama.Reddy@carlsonwagonlit.com',
                    'ERepolido@Carlsonwagonlit.com',
                    'Aristotle.Ruan@carlsonwagonlit.com',
                    'BinayaRanjan.Sabat@carlsonwagonlit.com',
                    'SharadUmesh.Talekar@carlsonwagonlit.com',
                    'Xavier.Tamag@carlsonwagonlit.com',
                    'MeholaJaen.Teodoro@carlsonwagonlit.com',
                    'Ankit.Tomar@carlsonwagonlit.com',
					'LadyDiane.Soriano@carlsonwagonlit.com',
					'James.Toplis@carlsonwagonlit.com',
					'Madhurima.Sarkar@carlsonwagonlit.com',
					'Norberlou.Tadeo@carlsonwagonlit.com'
                    ]
    ...
    msg = MIMEMultipart()
    msg['Subject'] = 'APAC Synergy Nightly Run Test Result on Build 19.4.153 - HK PC2 Full ELe'
    msg['From'] = sender
    ...
    for tc, error in zip(failed_tc, failed_tc_error):
        template = """
            <tr>
                <td style="text-align: left">""" + str(unic(tc)) + """</td>
                <td style="text-align: left">""" + str(unic(error)) + """</td>
            </tr>
            """        
    ...
    <span><br>Following are the last run execution status.<b><br><br>Test Result:<b><br><br></span>
      <table style="width: 600px;">
        ...
        <tbody>
            <tr>
               <td style="text-align: center;">""" + str(total_tc_executed) + """</td>
               <td style="text-align: center;">""" + str(total_tc_pass) + """</td>
               <td style="text-align: center;">""" + str(total_tc_fail) + """</td>
               <td style="text-align: center;">""" + str(percentage) + """</td>
            </tr>
        </tbody>
      </table>       
