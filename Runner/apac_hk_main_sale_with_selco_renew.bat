...
call pybot -d %LOGPATH%\HK\air_fare -i air_fareANDhkANDexchange  %ARGS%
call python sellco_login.py
call pybot -d %LOGPATH%\HK\air_fare -i air_fareANDhkANDfare_details  %ARGS%
call python sellco_login.py
call pybot -d %LOGPATH%\HK\air_fare -i air_fareANDhkANDairline_commission_and_commission_rebate %ARGS%
call python sellco_login.py
call pybot -d %LOGPATH%\HK\air_fare -i air_fareANDhkANDtransaction_fees %ARGS%
call python sellco_login.py
call pybot -d %LOGPATH%\HK\air_fare -i air_fareANDhkANDmultiple_fop %ARGS%
call python sellco_login.py
call pybot -d %LOGPATH%\HK\air_fare -i air_fareANDhkANDrestrictions %ARGS%
call python sellco_login.py
