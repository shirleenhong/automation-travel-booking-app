...
call pybot -d %LOGPATH%\uk\contact_tracking_integration -i contact_tracking_integrationANDamadeusANDuk %ARGS%
...
call pybot -d %LOGPATH%\uk\meetings_and_events -i meetings_and_eventsANDamadeusANDuk %ARGS%
