...
chdir /d %WORKSPACE%
REM ca test scripts
call pybot -d %LOGPATH%\ca\car -i carANDamadeusANDca %ARGS%
call pybot -d %LOGPATH%\ca\cust_refs -i cust_refsANDamadeusANDca %ARGS%
call pybot -d %LOGPATH%\ca\recap -i recapANDamadeusANDca %ARGS%
