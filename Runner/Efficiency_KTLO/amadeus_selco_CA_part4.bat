...
chdir /d %WORKSPACE%
REM ca test scripts
call pybot -d %LOGPATH%\ca\policy_check -i policy_checkANDamadeusANDca %ARGS%
call pybot -d %LOGPATH%\ca\pspt_and_visa -i pspt_and_visaANDamadeusANDca %ARGS%
call pybot -d %LOGPATH%\ca\price_tracking -i price_trackingANDamadeusANDca %ARGS%
