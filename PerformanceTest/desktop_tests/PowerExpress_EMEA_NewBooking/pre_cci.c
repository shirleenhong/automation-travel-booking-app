# 1 "d:\\desktoptest\\performancetest\\desktop_tests\\powerexpress_emea_newbooking\\\\combined_PowerExpress_EMEA_NewBooking.c"
# 1 "globals.h" 1
...
# 1 "d:\\desktoptest\\performancetest\\desktop_tests\\powerexpress_emea_newbooking\\\\combined_PowerExpress_EMEA_NewBooking.c" 2
...
# 3 "d:\\desktoptest\\performancetest\\desktop_tests\\powerexpress_emea_newbooking\\\\combined_PowerExpress_EMEA_NewBooking.c" 2
...
# 5 "d:\\desktoptest\\performancetest\\desktop_tests\\powerexpress_emea_newbooking\\\\combined_PowerExpress_EMEA_NewBooking.c" 2
...
lr_start_transaction("Creating PNR");
	...
	ctrx_type("call pybot --test \"New Booking\" -d d:\\seco\\result\\{CitrixLogin} -v version:18.10 -v test_environment:Test -v surname:{Surname} -v firstname:{Firstname} -v use_mock_env:{UseMockEnv} -v booking_iteration:{BookingIteration} --removekeywords WUKS D:\\DesktopTest\\PerformanceTest\\desktop_tests\\apac.txt", "last");
...
# 6 "d:\\desktoptest\\performancetest\\desktop_tests\\powerexpress_emea_newbooking\\\\combined_PowerExpress_EMEA_NewBooking.c" 2
...
# 7 "d:\\desktoptest\\performancetest\\desktop_tests\\powerexpress_emea_newbooking\\\\combined_PowerExpress_EMEA_NewBooking.c" 2
