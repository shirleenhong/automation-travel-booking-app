# 1 "c:\\users\\u001jcp\\documents\\vugen\\scripts\\powerexpress_emea_citrixclient33\\powerexpress_emea_senditin\\\\combined_PowerExpress_EMEA_SendItin.c"
...
# 1 "c:\\users\\u001jcp\\documents\\vugen\\scripts\\powerexpress_emea_citrixclient33\\powerexpress_emea_senditin\\\\combined_PowerExpress_EMEA_SendItin.c" 2
...
# 2 "c:\\users\\u001jcp\\documents\\vugen\\scripts\\powerexpress_emea_citrixclient33\\powerexpress_emea_senditin\\\\combined_PowerExpress_EMEA_SendItin.c" 2
...
# 3 "c:\\users\\u001jcp\\documents\\vugen\\scripts\\powerexpress_emea_citrixclient33\\powerexpress_emea_senditin\\\\combined_PowerExpress_EMEA_SendItin.c" 2
...
lr_start_transaction("Citrix_Login");
	...
	ctrx_nfuse_connect("https://emea.cwtdesktop.pilot.int.carlsonwagonlit.com/Citrix/PilotWeb/Resources/LaunchIca/RGVmYXVsdEFnZ3JlZ2F0aW9uR3JvdXAuXFNFQ08gUGVyZm9ybWFuY2UgVGVzdGluZw--.ica?CsrfToken={CsrfToken}&IsUsingHttps=Yes&displayNameDesktopTitle=SECO%20Performance%20Testing&launchId={LaunchID}", "last");
...
lr_start_transaction("Sellco Login");
	...
	ctrx_type("chrome https://acceptance.custom.sellingplatformconnect.amadeus.com", "", "last");
...
# 5 "c:\\users\\u001jcp\\documents\\vugen\\scripts\\powerexpress_emea_citrixclient33\\powerexpress_emea_senditin\\\\combined_PowerExpress_EMEA_SendItin.c" 2
...
lr_start_transaction("Creating PNR");
	...
	ctrx_type("call pybot --test \"Send Itin\" -v version:18.10 -v surname:{Surname} -v firstname:{Firstname} -v use_mock_env:{UseMockEnv} -v booking_iteration:{BookingIteration} C:\\seco\\desktop_tests\\apac.txt", "", "last");
...
# 6 "c:\\users\\u001jcp\\documents\\vugen\\scripts\\powerexpress_emea_citrixclient33\\powerexpress_emea_senditin\\\\combined_PowerExpress_EMEA_SendItin.c" 2
...
# 7 "c:\\users\\u001jcp\\documents\\vugen\\scripts\\powerexpress_emea_citrixclient33\\powerexpress_emea_senditin\\\\combined_PowerExpress_EMEA_SendItin.c" 2
